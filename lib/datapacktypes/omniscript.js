    ...
    try {
        {
            ...
            await Promise.all([ page.waitForNavigation(), page.goto(omniScriptDisignerpageLink, { timeout }) ]);
            ...
            if (errorMessage) {
                ...
                await this.vlocity.utilityservice.savePuppeteerScreenLog(jobInfo, page, omniScriptKey);
                await this.deactivateOmniScript(omniScriptId);
            }
        }
    } catch (e) {
